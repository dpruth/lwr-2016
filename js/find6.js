...
coolfind.create_find_div = function()
{
	...
	var find_html = "";
	var find_div_style = "display: inline-block; vertical-align: middle; z-index:100000; box-shadow:0 0 10px rgba(0,0,0,0.8); background-color:white;";
	var button_style = "background-color:#eee !important; color:#bbb; box-shadow:none !important; display: inline-block;  min-height: 31px; min-width: 32px; vertical-align: middle; text-align: center; font-size: 16px; border: none; background: lightgray; cursor: pointer; padding: 4px; margin: 0; -webkit-user-select:none; -ms-user-select: none;";
	var menu_style = "background-color: #fff; display: none; max-width:300px;";
	var input_style = "display: inline; max-width:180px; background-color:transparent !important; font-size:12px; height:30px; box-shadow:none !important; margin-left:4px;"; // Version 6.0b - changed width: 55% to max-width: 55%
	...
	coolfind.find_button_html = '<span class="fa fa-search"></span>';
	...
	if (coolfind.lock_button)
	{
		...
		find_div.style.top = "20px";
		find_div.style.right = "20px";
	}
	...
	find_html += "<button class='cool_find_btn'"+
		//" style='"+button_style+"'"+
		" title='Find Previous' onclick='coolfind.findprev();'><span class='fa fa-angle-up'></span></button>"+
		"<button class='cool_find_btn' id='cool_find_next'"+ // Version 6.0b - Added id='cool_find_next' for accessibility
		//" style='"+button_style+"'"+
		" title='Find Next' onclick='coolfind.findit();'><span class='fa fa-angle-down'></span></button> ";
...
coolfind.find_menu =  function(that)
{
	...
	if (that.nextElementSibling.style.display != "inline-block")
	{
		...
		that.innerHTML = "<span class='fa fa-remove'></span>";
		that.title = "Close";
...
coolfind.findit = function ()
{
	...
	else
	{
		...
		{
			cool_find_msg.innerHTML = "&nbsp;<b>0/0</b>"; // ver 5.1 - 10/17/2014 - changed from "Not Found"
			coolfind.find_pointer = -1;
		}
	}
	findwindow.style.visibility = 'visible';
...
coolfind.scrollToPosition = function(field)
{
   ...
   if (field)
   {
	   ...
	   theElement = theElement.offsetParent;
		...
		window.scrollTo(elemPosX ,elemPosY - 70);
